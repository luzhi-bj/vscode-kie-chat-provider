...
const BUILT_IN_KIE_MODELS: ReadonlyArray<Omit<KieProviderModel, 'apiKeySecretKey'>> = [
  ...
  {
    id: 'gpt-5-5',
    displayName: 'GPT 5.5 (KIE)',
    endpoint: 'https://api.kie.ai/codex/v1/responses',
    protocol: 'openai-responses',
    requestModel: 'gpt-5-5',
    family: 'gpt',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in GPT 5.5 responses endpoint',
    detail: 'KIE built-in · responses',
    maxInputTokens: 262144,
    maxOutputTokens: 16384,
    enableVision: true,
  ...
  {
    id: 'gpt-5-6-luna',
    displayName: 'GPT 5.6 Luna (KIE)',
    endpoint: 'https://api.kie.ai/codex/v1/responses',
    protocol: 'openai-responses',
    requestModel: 'gpt-5-6-luna',
    family: 'gpt',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in GPT 5.6 Luna responses endpoint',
    detail: 'KIE built-in · responses',
    maxInputTokens: 262144,
    maxOutputTokens: 16384,
    enableVision: true,
  ...
  {
    id: 'gpt-5-6-terra',
    displayName: 'GPT 5.6 Terra (KIE)',
    endpoint: 'https://api.kie.ai/codex/v1/responses',
    protocol: 'openai-responses',
    requestModel: 'gpt-5-6-terra',
    family: 'gpt',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in GPT 5.6 Terra responses endpoint',
    detail: 'KIE built-in · responses',
    maxInputTokens: 262144,
    maxOutputTokens: 16384,
    enableVision: true,
  ...
  {
    id: 'gpt-5-6-sol',
    displayName: 'GPT 5.6 Sol (KIE)',
    endpoint: 'https://api.kie.ai/codex/v1/responses',
    protocol: 'openai-responses',
    requestModel: 'gpt-5-6-sol',
    family: 'gpt',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in GPT 5.6 Sol responses endpoint',
    detail: 'KIE built-in · responses',
    maxInputTokens: 262144,
    maxOutputTokens: 16384,
    enableVision: true,
  ...
  {
    id: 'grok-4-6',
    displayName: 'Grok 4.6 (KIE)',
    endpoint: 'https://api.kie.ai/grok/v1/responses',
    protocol: 'openai-responses',
    requestModel: 'grok-4-6',
    family: 'grok',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in Grok 4.6 grok/responses endpoint',
    detail: 'KIE built-in · grok/responses',
    maxInputTokens: 262144,
    maxOutputTokens: 16384,
    enableVision: true,
    enableTools: true,
  ...
  {
    id: 'claude-opus-4-7',
    displayName: 'Claude Opus 4.7 (KIE)',
    endpoint: 'https://api.kie.ai/claude/v1/messages',
    protocol: 'claude',
    requestModel: 'claude-opus-4-7',
    family: 'claude',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in Claude Opus 4.7 messages endpoint',
    detail: 'KIE built-in · claude/messages',
    maxInputTokens: 160000,
    maxOutputTokens: 8192,
    enableVision: true,
  ...
  {
    id: 'claude-opus-4-8',
    displayName: 'Claude Opus 4.8 (KIE)',
    endpoint: 'https://api.kie.ai/claude/v1/messages',
    protocol: 'claude',
    requestModel: 'claude-opus-4-8',
    family: 'claude',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in Claude Opus 4.8 messages endpoint',
    detail: 'KIE built-in · claude/messages',
    maxInputTokens: 160000,
    maxOutputTokens: 8192,
    enableVision: true,
  ...
  {
    id: 'claude-opus-5',
    displayName: 'Claude Opus 5 (KIE)',
    endpoint: 'https://api.kie.ai/claude/v1/messages',
    protocol: 'claude',
    requestModel: 'claude-opus-5',
    family: 'claude',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in Claude Opus 5 messages endpoint',
    detail: 'KIE built-in · claude/messages',
    maxInputTokens: 160000,
    maxOutputTokens: 8192,
    enableVision: true,
  ...
  {
    id: 'claude-fable-5',
    displayName: 'Claude Fable 5 (KIE)',
    endpoint: 'https://api.kie.ai/claude/v1/messages',
    protocol: 'claude',
    requestModel: 'claude-fable-5',
    family: 'claude',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in Claude Fable 5 messages endpoint',
    detail: 'KIE built-in · claude/messages · no tool calling',
    maxInputTokens: 160000,
    maxOutputTokens: 8192,
    enableVision: false,
    enableTools: false,
  ...
  {
    id: 'claude-sonnet-5',
    displayName: 'Claude Sonnet 5 (KIE)',
    endpoint: 'https://api.kie.ai/claude/v1/messages',
    protocol: 'claude',
    requestModel: 'claude-sonnet-5',
    family: 'claude',
    vendorVersion: '1.0.0',
    tooltip: 'KIE built-in Claude Sonnet 5 messages endpoint',
    detail: 'KIE built-in · claude/messages',
    maxInputTokens: 160000,
    maxOutputTokens: 8192,
    enableVision: true,
